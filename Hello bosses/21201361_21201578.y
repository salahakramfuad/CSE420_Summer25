...
%token IF ELSE FOR NOT LPAREN RPAREN LCURL RCURL WHILE DO BREAK RETURN INT CONST_FLOAT CHAR VOID DOUBLE SWITCH CASE DEFAULT PRINTF GOTO CONTINUE ADDOP MULOP INCOP DECOP RELOP ASSIGNOP LOGICOP LTHIRD RTHIRD SEMICOLON COMMA ID CONST_INT 
